...
plot(0, xlim= range(jt$index), ylim=range(jt$V4),xlab = "Transaction #", ylab="Transaction Price",main="Buyers")
...
infBck_s <-     subset(jt, jt$V6=="InfBckAgent")
uninfLevel_s <- subset(jt, jt$V6=="UninfFwdLevelAgent")
uninfDelta_s <- subset(jt, jt$V6=="UninfFwdDeltaAgent")
...
plot(0, xlim= range(jt$index), ylim=range(jt$V4),xlab = "Transaction #", ylab="Transaction Price",main="Transactions (inner = Seller, outer = Buyer)")
points(infBck$index, infBck$V4, col = c('red'), pch=46, cex=10)
points(uninfLevel$index, uninfLevel$V4, col = c('blue'), pch=46, cex=10)
points(uninfDelta$index, uninfDelta$V4, col = c('green'), pch=46, cex=10)

points(infBck_s$index, infBck_s$V4, col = c('red'), pch=46, cex=5)
points(uninfLevel_s$index, uninfLevel_s$V4, col = c('blue'), pch=46, cex=5)
points(uninfDelta_s$index, uninfDelta_s$V4, col = c('green'), pch=46, cex=5)
